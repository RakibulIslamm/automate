...
function GithubIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="2 2 20 20" fill="currentColor" className={className} aria-hidden>
...
const SOCIAL: Array<{ label: string; href: string; icon: React.ComponentType<{ className?: string }> }> = [
  { label: 'GitHub', href: 'https://github.com/RakibulIslamm/automate', icon: GithubIcon },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/d-rakibul-islam/', icon: LinkedinIcon },
];
